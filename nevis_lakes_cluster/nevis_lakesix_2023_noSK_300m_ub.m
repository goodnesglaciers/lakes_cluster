...
% LAS 18 JUN 2024 - Swap in 2023 RACMO runoff from Brice

format compact;
clear
oo.root = '';          % filename root
oo.fn = 'nevis_lakesix_2023_noSK_300m_ub_restart';  % filename
...
load('runoff_2023_nevis_noSK_300m.mat');
runoff_time = 1:1:365;
...
pp.runoff_function = @(t) runoff(((t*ps.t)/pd.td),runoff_2023_nevis.runoff)./ps.m;  % distributed input (m/sec)
...
load('nevis_lakesix_2023_noSK_300m_ub/0262.mat','vv','tt') % load a former timestep as an initial
% run at a 1 day timestep
[tt,vv,info] = nevis_timesteps((263:1:300)*pd.td/ps.t,vv,aa,pp,gg,oo,pd,ps);
