...
oo.fn = 'nevis_lakesix_noSK_300m_ub_restart';  % filename
...
load('nevis_lakesix_noSK_300m_ub/0002.mat','vv','tt') % load a former timestep as an initial
% run at a 1 day timestep
[tt,vv,info] = nevis_timesteps([3:1:334]*pd.td/ps.t,vv,aa,pp,gg,oo,pd,ps);
