function nevis_panel9_movie_year_lakesix_2022214(fn,tis)
...
% discharge
    ...
    % color bar
    tmp = get(gca,'position'); 
    cbar_size = [tmp(1)+tmp(3)-0.07 tmp(2)+tmp(4)*1/8 0.008 tmp(4)*6/8];
    cx5 = colorbar('peer',gca,'vertical','position',cbar_size,'YAxislocation','right');
    text(-56,32,'q [ m^2 s^{-1} ]','VerticalAlignment','bottom','HorizontalAlignment','right');
