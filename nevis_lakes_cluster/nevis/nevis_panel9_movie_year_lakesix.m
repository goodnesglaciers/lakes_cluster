function nevis_panel9_movie_year_lakesix(fn,tis)
...
axe5 = axes('Position',[0.305 0.37 0.35 0.25],'Box','on','NextPlot','add','XTickLabel',[],'YTickLabel',[]); 
...
% discharge
    ...
    text(-36,22,'q [ m^2 s^{-1} ]','VerticalAlignment','bottom','HorizontalAlignment','right');
    text(-38,10,'\phi [ MPa ]','VerticalAlignment','bottom','HorizontalAlignment','right');
