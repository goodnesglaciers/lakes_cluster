function nevis_panel9_movie_year(fn,tis)
...
load('nevis_h22222_ubspatial_sheetperm2.mat');
load([fn,'/0001']);
...
axes(axe9)
    ...
    rectangle('Position',[229.5 -0.99 0.4 3.46],'EdgeColor','none','FaceColor',[1 0.85 0.85]);
    ...
    legend(celllgd, 'Location','SouthWest','NumColumns',[3]);
    legend boxoff
