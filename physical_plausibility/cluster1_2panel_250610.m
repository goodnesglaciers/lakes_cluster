...
ice_thickness_10s = environs_lakes_2022.H(cluster_10s); % m
% all thicknesses are within 70 m of 1000m, so use 1-km for blister depth 
...
origin_cluster = [environs_lakes_2022.X_km(cluster_10s); environs_lakes_2022.Y_km(cluster_10s)];
% blank X-Y grid grid points = nevis xx yy
xx_vec = reshape(xx,601*264,1); 
yy_vec = reshape(yy,601*264,1);
for i=1:length(cluster_10s)
    % flow angle
    theta(i,1) = flow_angle((ID_stresses_sig1_winter(cluster_10s(i),1))); % [ deg ]
    % rotation matrix
...
% 10s
cluster_10s = [34, 47, 72, 78, 81];
cc1 = plot([environs_lakes_2022.X_km(cluster_10s(1)) environs_lakes_2022.X_km(cluster_10s(2))],...
    [environs_lakes_2022.Y_km(cluster_10s(1)) environs_lakes_2022.Y_km(cluster_10s(2))],...
    '-','LineWidth',2,'Color',grey_connections);
cc11 =plot([environs_lakes_2022.X_km(cluster_10s(2)) environs_lakes_2022.X_km(cluster_10s(3))],...
    [environs_lakes_2022.Y_km(cluster_10s(2)) environs_lakes_2022.Y_km(cluster_10s(3))],...
    '-','LineWidth',2,'Color',grey_connections);
cc12 =plot([environs_lakes_2022.X_km(cluster_10s(3)) environs_lakes_2022.X_km(cluster_10s(4))],...
    [environs_lakes_2022.Y_km(cluster_10s(3)) environs_lakes_2022.Y_km(cluster_10s(4))],...
    '-','LineWidth',2,'Color',grey_connections);
cc13 =plot([environs_lakes_2022.X_km(cluster_10s(4)) environs_lakes_2022.X_km(cluster_10s(5))],...
    [environs_lakes_2022.Y_km(cluster_10s(4)) environs_lakes_2022.Y_km(cluster_10s(5))],...
    '-','LineWidth',2,'Color',grey_connections);
% text(-14.5, -17.5, 'C1','FontSize',fontsize+6,'FontName','Avenir','FontAngle','italic',...
%     'FontWeight','bold','Color',grey_connections);
% lake identification number labels
text(environs_lakes_2022.X_km(cluster_10s(1))+1.5, environs_lakes_2022.Y_km(cluster_10s(1))+0,...
    "L34","Color",'w',"FontSize",fontsize,"FontName","Helvetical",'FontWeight','Bold','FontAngle','italic')
text(environs_lakes_2022.X_km(cluster_10s(2))+1, environs_lakes_2022.Y_km(cluster_10s(2)),...
    "L47","Color",'k',"FontSize",fontsize,"FontName","Helvetical",'FontWeight','Bold','FontAngle','italic')
text(environs_lakes_2022.X_km(cluster_10s(3))+1.25, environs_lakes_2022.Y_km(cluster_10s(3)),...
    "L72","Color",'k',"FontSize",fontsize,"FontName","Helvetical",'FontWeight','Bold','FontAngle','italic')
text(environs_lakes_2022.X_km(cluster_10s(4))+1, environs_lakes_2022.Y_km(cluster_10s(4))-0.75,...
    "L78","Color",'k',"FontSize",fontsize,"FontName","Helvetical",'FontWeight','Bold','FontAngle','italic')
text(environs_lakes_2022.X_km(cluster_10s(4))-0.75, environs_lakes_2022.Y_km(cluster_10s(4))-2.75,...
    "(L1B)","Color",'k',"FontSize",fontsize,"FontName","Helvetical",'FontWeight','Bold','FontAngle','italic')
text(environs_lakes_2022.X_km(cluster_10s(5))+1.25, environs_lakes_2022.Y_km(cluster_10s(5))+0.5,...
    "L81 (L1A)","Color",'k',"FontSize",fontsize,"FontName","Helvetical",'FontWeight','Bold','FontAngle','italic')
...
%% print figure
print(gcf,'-dpng','-r300',sprintf('../paperfigs/paperfig7_%s_260129.png',cluster_name)); 
print(gcf,'-dpng','-r300',sprintf('../paperfigs/suppfig1.1_%s_260129.png',cluster_name)); 