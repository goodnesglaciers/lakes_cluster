function [sigma_ij_1000m_SLder] = Nsurface_displ_strain_stress_1000m_function(patches_idealized,cluster_name)
...
% 19 Sept 2024 LAS -- change to function for cluster chronologies

clear Gsurface
%% load Green function matrix, idealized opening and slip
load('forward_okada85/Gsurface1000m_strain.mat') % 40 x 40 patch bed
...
Vtot = patches_idealized.Vi./1e9; % [ km^3 ] cluster lake volumes
...
surface_disp_1000m.Disp_E = Disp_E;
surface_disp_1000m.Disp_N = Disp_N;
surface_disp_1000m.Disp_U = Disp_U;
surface_disp_1000m.Disp_E_slip = Disp_E_slip;
surface_disp_1000m.Disp_N_slip = Disp_N_slip;
surface_disp_1000m.Disp_U_slip = Disp_U_slip;
surface_disp_1000m.Disp_E_open = Disp_E_open;
surface_disp_1000m.Disp_N_open = Disp_N_open;
surface_disp_1000m.Disp_U_open = Disp_U_open;
% save surface_disp_1000m.mat surface_disp_1000m
%load surface_disp_1000m.mat
...
%% save for plotting 
sigma_ij_1000m_SLder.sigma_xx = sigma_xx;
sigma_ij_1000m_SLder.sigma_xy = sigma_xy;
sigma_ij_1000m_SLder.sigma_xz = sigma_xz;
sigma_ij_1000m_SLder.sigma_yx = sigma_yx;
sigma_ij_1000m_SLder.sigma_yy = sigma_yy;
sigma_ij_1000m_SLder.sigma_yz = sigma_yz;
sigma_ij_1000m_SLder.sigma_zx = sigma_zx;
sigma_ij_1000m_SLder.sigma_zy = sigma_zy;
sigma_ij_1000m_SLder.sigma_zz = sigma_zz;
sigma_ij_1000m_SLder.xx = xx;
sigma_ij_1000m_SLder.yy = yy; 

% sigma_ij_1000m_SLder.sigma_xx_slip = sigma_xx_slip;
% sigma_ij_1000m_SLder.sigma_xy_slip = sigma_xy_slip;
% sigma_ij_1000m_SLder.sigma_xz_slip = sigma_xz_slip;
% sigma_ij_1000m_SLder.sigma_yx_slip = sigma_yx_slip;
% sigma_ij_1000m_SLder.sigma_yy_slip = sigma_yy_slip;
% sigma_ij_1000m_SLder.sigma_yz_slip = sigma_yz_slip;
% sigma_ij_1000m_SLder.sigma_zx_slip = sigma_zx_slip;
% sigma_ij_1000m_SLder.sigma_zy_slip = sigma_zy_slip;
% sigma_ij_1000m_SLder.sigma_zz_slip = sigma_zz_slip;
% 
% sigma_ij_1000m_SLder.sigma_xx_open = sigma_xx_open;
% sigma_ij_1000m_SLder.sigma_xy_open = sigma_xy_open;
% sigma_ij_1000m_SLder.sigma_xz_open = sigma_xz_open;
% sigma_ij_1000m_SLder.sigma_yx_open = sigma_yx_open;
% sigma_ij_1000m_SLder.sigma_yy_open = sigma_yy_open;
% sigma_ij_1000m_SLder.sigma_yz_open = sigma_yz_open;
% sigma_ij_1000m_SLder.sigma_zx_open = sigma_zx_open;
% sigma_ij_1000m_SLder.sigma_zy_open = sigma_zy_open;
% sigma_ij_1000m_SLder.sigma_zz_open = sigma_zz_open;

save_name = sprintf('sigma_ij_1000m_',cluster_name,'.mat');
save save_name sigma_ij_1000m_SLder
...
[C1,h1]=contourf(xx, yy, reshape(surface_disp_1000m.Disp_E(i,:),121,121),vv);
...
text(-21,19,sprintf('H = 1000 m   V = %4.3f km^{3}',Vtot(i)),'FontWeight','bold','FontSize',10);

axes(axe2)
[C2,h2]=contourf(xx, yy, reshape(surface_disp_1000m.Disp_N(i,:),121,121),vv);
...
[C3,h3]=contourf(xx, yy, reshape(surface_disp_1000m.Disp_U(i,:),121,121),vvv);
...
% sigma_zz
axes(axe9)
[~,h6]=contourf(xx, yy, reshape(sigma_zz(i,:),121,121)./1e3,vvKPA);
...
%path='Forward_1000m_check_plots'; %the folder where you want to put the file
name=sprintf('%s/%02d_1000m_bedopen_bedslip_%s',cluster_name,i,cluster_name); %what you want the file to be called
