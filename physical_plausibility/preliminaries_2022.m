% physics-informed cluster chronology 2022 preamble
% 
...
addpath('../GNSS_derived/strain_rates_2022/')

%% load prelimiaries for site locations in 2022
% load station names
station_names_2022 = load('../GNSS_derived/strain_rates_2022/station_names_2022.mat');
num_sta_22 = length(station_names_2022.station_names); % number of stations
station_names_2022_short = upper(vertcat(station_names_2022.station_names(1,1:21)')); % omit SQ33 (#18)
% load site locations 2022
load('../GNSS_derived/strain_rates_2022/polarstereo_stations_2022_short.mat') 

% load lake boundaries, centre points, drainage dates from FASTER for 2022
load('../GNSS_derived/strain_rates_2022/environs_lakes_2022B_250416_noboundaries.mat') % drainage dates & no lake boundaries
environs_lakes_2022 = environs_lakes; environs_lakes_2022B = environs_lakes; 
X_km = environs_lakes_2022.X_km; 
Y_km = environs_lakes_2022.Y_km;
Surface_elev = environs_lakes_2022.S;
...
NT = shaperead('../GNSS_derived/strain_rates_2022/NatalieTurner_Moulins_2022/moulins.shp');
...
load('../GNSS_derived/strain_rates_2022/laketypeing_2022_250930_result.mat')
...
load('../homogeneous_poisson/daily_lake_HFpossible_classifier_S1S2_2022_240829.mat')
% within subglacial ROI:
...
daily_lake_classifier(34,194)=1;
daily_lake_classifier(34,196)=3;
daily_lake_classifier(72,196:197)=3;

% lake locations
load('../GNSS_derived/strain_rates_2022/max_extent_indices_GEOD.mat');


%% load in in nevis formation
...
% load nevis discharge q outputs
    ...
    addpath('../nevis_lakes_cluster/nevis_lakesix_noSK_300m_ub/')
    % load initial timestep
    fn = '../../too-big-files/nevis_lakesix_noSK_300m_ub';
...
load('../nevis_lakes_cluster/nevis_lakesix_2022_noSK_300m_ub_unique.mat')

%% winter stresses from MEaSUREs Annual or Monthly compilation Sentinel-1 SAR
load('winter-stress-datasets/stresses_nlake_2022Annual_S12_250219.mat');
stresses_XB = stresses_nlake_2022Annual_S12.XB_strain_grid_sub; % [ m ]
stresses_YB = stresses_nlake_2022Annual_S12.YB_strain_grid_sub; % [ m ]
stresses_sig1_winter = stresses_nlake_2022Annual_S12.Smax; % [ Pa ]
flow_angle = stresses_nlake_2022Annual_S12.flow_angle; % [ degrees ]
