...
% lake volumes for C5 cluster:
cluster_name = 'C5';
cluster_mid = [146, 150, 152, 154, 162, 171, 179, 181, 194, 196];
cluster_mid = [146, 150, 152, 162, 171, 179, 181, 194, 196]; % remove 154
...
ice_thickness_mid = environs_lakes_2023.H(cluster_mid) % m
...
origin_cluster = [environs_lakes_2023.X_km(cluster_mid); environs_lakes_2023.Y_km(cluster_mid)];
% blank X-Y grid grid points = nevis xx yy
xx_vec = reshape(xx,601*264,1); 
yy_vec = reshape(yy,601*264,1);
for i=1:length(cluster_mid)
    % flow angle
    theta = flow_angle((ID_stresses_sig1_winter(cluster_mid(i),1))); % [ deg ]
    % rotation matrix
...
theta_range = 140:1:210; % degrees with East = 0 degrees. --> 230–310 in ice-flow direction
...
% mid
cluster_mid = [146, 150, 152, 162, 171, 179, 181, 194, 196];
cc1 = plot([environs_lakes_2023.X_km(cluster_mid(1)) environs_lakes_2023.X_km(cluster_mid(5))],...
    [environs_lakes_2023.Y_km(cluster_mid(1)) environs_lakes_2023.Y_km(cluster_mid(5))],...
    '-','LineWidth',2.5,'Color',grey_connections);
cc11 =plot([environs_lakes_2023.X_km(cluster_mid(2)) environs_lakes_2023.X_km(cluster_mid(3))],...
    [environs_lakes_2023.Y_km(cluster_mid(2)) environs_lakes_2023.Y_km(cluster_mid(3))],...
    '-','LineWidth',2.5,'Color',grey_connections);
cc12 =plot([environs_lakes_2023.X_km(cluster_mid(5)) environs_lakes_2023.X_km(cluster_mid(7))],...
    [environs_lakes_2023.Y_km(cluster_mid(5)) environs_lakes_2023.Y_km(cluster_mid(7))],...
    '-','LineWidth',2.5,'Color',grey_connections);
cc13 =plot([environs_lakes_2023.X_km(cluster_mid(4)) environs_lakes_2023.X_km(cluster_mid(6))],...
    [environs_lakes_2023.Y_km(cluster_mid(4)) environs_lakes_2023.Y_km(cluster_mid(6))],...
    '-','LineWidth',2.5,'Color',grey_connections);
cc13 =plot([environs_lakes_2023.X_km(cluster_mid(8)) environs_lakes_2023.X_km(cluster_mid(4))],...
    [environs_lakes_2023.Y_km(cluster_mid(8)) environs_lakes_2023.Y_km(cluster_mid(4))],...
    '-','LineWidth',2.5,'Color',grey_connections);
cc13 =plot([environs_lakes_2023.X_km(cluster_mid(8)) environs_lakes_2023.X_km(cluster_mid(9))],...
    [environs_lakes_2023.Y_km(cluster_mid(8)) environs_lakes_2023.Y_km(cluster_mid(9))],...
    '-','LineWidth',2.5,'Color',grey_connections);
cc13 =plot([environs_lakes_2023.X_km(cluster_mid(6)) environs_lakes_2023.X_km(cluster_mid(9))],...
    [environs_lakes_2023.Y_km(cluster_mid(6)) environs_lakes_2023.Y_km(cluster_mid(9))],...
    '-','LineWidth',2.5,'Color',grey_connections);
% lake identificcation number labels
text(environs_lakes_2023.X_km(cluster_mid(1))+1.25, environs_lakes_2023.Y_km(cluster_mid(1))+1,...
    "L146","Color",'k',"FontSize",fontsize,"FontName","Helvetical",'FontWeight','Bold','FontAngle','italic')
text(environs_lakes_2023.X_km(cluster_mid(2))+1, environs_lakes_2023.Y_km(cluster_mid(2)),...
    "L150","Color",'k',"FontSize",fontsize,"FontName","Helvetical",'FontWeight','Bold','FontAngle','italic')
text(environs_lakes_2023.X_km(cluster_mid(3))+1, environs_lakes_2023.Y_km(cluster_mid(3)),...
    "L152","Color",'k',"FontSize",fontsize,"FontName","Helvetical",'FontWeight','Bold','FontAngle','italic')
text(environs_lakes_2023.X_km(cluster_mid(4))-1.5, environs_lakes_2023.Y_km(cluster_mid(4))+2.25,...
    "L162","Color",'k',"FontSize",fontsize,"FontName","Helvetical",'FontWeight','Bold','FontAngle','italic')
text(environs_lakes_2023.X_km(cluster_mid(5))+1, environs_lakes_2023.Y_km(cluster_mid(5)),...
    "L171","Color",'k',"FontSize",fontsize,"FontName","Helvetical",'FontWeight','Bold','FontAngle','italic')
text(environs_lakes_2023.X_km(cluster_mid(6))-3, environs_lakes_2023.Y_km(cluster_mid(6))-2,...
    "L179","Color",'k',"FontSize",fontsize,"FontName","Helvetical",'FontWeight','Bold','FontAngle','italic')
text(environs_lakes_2023.X_km(cluster_mid(7))+1, environs_lakes_2023.Y_km(cluster_mid(7))-1,...
    "L181","Color",'k',"FontSize",fontsize,"FontName","Helvetical",'FontWeight','Bold','FontAngle','italic')
text(environs_lakes_2023.X_km(cluster_mid(8))+1, environs_lakes_2023.Y_km(cluster_mid(8)),...
    "L194","Color",'k',"FontSize",fontsize,"FontName","Helvetical",'FontWeight','Bold','FontAngle','italic')
text(environs_lakes_2023.X_km(cluster_mid(9))+1, environs_lakes_2023.Y_km(cluster_mid(9)),...
    "L196","Color",'k',"FontSize",fontsize,"FontName","Helvetical",'FontWeight','Bold','FontAngle','italic')
...
%% print figure
print(gcf,'-dpng','-r300',sprintf('../paperfigs/suppfig5.1_%s_260129.png',cluster_name)); 