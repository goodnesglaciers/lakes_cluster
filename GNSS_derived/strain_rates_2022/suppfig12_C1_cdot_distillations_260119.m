...
% removed small map
% LAS 2024-10-10: days of C1 cluster
...
lake_dates = [195.25, 210, 214.5, 210]; % 100s, MHIH, 200s, L3B
...
y_plot_strain = [-0.05 0.10]; % 2022 cluster C1
y_plot_strain_tick = 0.025;
y_plot_cdot = [-1.5 0.30];
y_plot_cdot_tick = 0.30; y_plot_cdot_interval = y_plot_cdot_tick;
plot_cdot_range = 6; %y_plot_cdot(2)-y_plot_cdot(1);
run_c_dot_label = [{'2'};{'4'};{'6'};{'-0.3'};{'0.0'};{'0.3'}];
...
% runoff
patch_vert = ((4*y_plot_cdot_interval)/plot_cdot_range).*(nanmean(runoff_2022_nevis(:,ID(4:9,1)),2)./10); % shrink to c_dot scale [(num_intervals*interval_size)/RUnoff Range (8 cm)]
...
text(t_plot(2)-0.15,y_plot_cdot(2)-0.75,'within-basin 10s','FontName','AvenirBold','FontSize',fontsize+1,'FontAngle','italic','HorizontalAlignment','right')
text(t_plot(1)-0.80, y_plot_cdot(2),'a','FontName','Helvetica','FontSize',fontsize+2);

text(t_plot(1)+0.5, y_plot_cdot(2)-0.45, 'SQ11','FontName','AvenirBold','FontSize',fontsize,'Color',[0    0.4470    0.7410],'HorizontalAlignment','center');
text(t_plot(1)+1.5, y_plot_cdot(2)-0.45, 'SQ12','FontName','AvenirBold','FontSize',fontsize,'Color',[0.8500    0.3250    0.0980],'HorizontalAlignment','center');
text(t_plot(1)+2.5, y_plot_cdot(2)-0.45, 'SQ13','FontName','AvenirBold','FontSize',fontsize,'Color',[0.9290    0.6940    0.1250],'HorizontalAlignment','center');
text(t_plot(1)+3.5, y_plot_cdot(2)-0.45, 'SQ14','FontName','AvenirBold','FontSize',fontsize,'Color',[0.4940    0.1840    0.5560],'HorizontalAlignment','center');
text(t_plot(1)+4.5, y_plot_cdot(2)-0.45, 'SQ15','FontName','AvenirBold','FontSize',fontsize,'Color',[0.4660    0.6740    0.1880],'HorizontalAlignment','center');
text(t_plot(1)+5.5, y_plot_cdot(2)-0.45, 'SQ16','FontName','AvenirBold','FontSize',fontsize,'Color',[0.3010    0.7450    0.9330],'HorizontalAlignment','center');

text(lake_dates(1)+0.15, y_plot_cdot(1)+0.15, {'L1A';'L1B'},'FontName','AvenirBold','FontSize',fontsize+1,...
...
ylabel('Runoff [cm w.e.] \hspace{6mm} $\dot{c}$  [ m d$^{-1}$ ] \hspace{0mm}','Interpreter','latex','FontSize',fontsize)
set(gca,'ytick',y_plot_cdot(1)+y_plot_cdot_tick:y_plot_cdot_tick:y_plot_cdot(2),'YTickLabel',run_c_dot_label);
text(t_plot(2)-0.15,y_plot_cdot(2)-0.75,'10s-to-tiepoints','FontName','AvenirBold','FontSize',fontsize+1,'FontAngle','italic','HorizontalAlignment','right')
text(t_plot(1)-0.80, y_plot_cdot(2),'b','FontName','Helvetica','FontSize',fontsize+2);
text(t_plot(1)+0.5, y_plot_cdot(2)-0.10, 'QIET','FontName','AvenirBold','FontSize',fontsize,'Color',[0    0.4470    0.7410],'HorizontalAlignment','center');
text(t_plot(1)+1.5, y_plot_cdot(2)-0.10, 'MLOW','FontName','AvenirBold','FontSize',fontsize,'Color',[0.8500    0.3250    0.0980],'HorizontalAlignment','center');
...
legend(['SQ12' char(8211) 'QIET'],['SQ16' char(8211) 'QIET'],['SQ12' char(8211) 'MLOW'],'NumColumns',3,...
    'Location','West','EdgeColor','none');    % 'Position', [0.2275 0.630 0.01 0.01],'EdgeColor','none')
set(gca,'FontName','Avenir','tickdir','in','LineWidth',0.6,'FontSize',fontsize); 
set(gca,'ytick',y_plot_strain(1)+y_plot_strain_tick:y_plot_strain_tick:y_plot_strain(2))
...
set(gca,'ytick',y_plot_cdot(1)+y_plot_cdot_tick:y_plot_cdot_tick:y_plot_cdot(2),'YTickLabel',run_c_dot_label);
text(t_plot(2)-0.15,y_plot_cdot(2)-0.75,'tiepoints-to-20s','FontName','AvenirBold','FontSize',fontsize+1,'FontAngle','italic','HorizontalAlignment','right')
text(t_plot(1)-0.80, y_plot_cdot(2),'c','FontName','Helvetica','FontSize',fontsize+2);
text(t_plot(1)+0.5, y_plot_cdot(2)-0.10, 'QIET','FontName','AvenirBold','FontSize',fontsize,'Color',[0    0.4470    0.7410],'HorizontalAlignment','center');
text(t_plot(1)+1.5, y_plot_cdot(2)-0.10, 'MLOW','FontName','AvenirBold','FontSize',fontsize,'Color',[0.8500    0.3250    0.0980],'HorizontalAlignment','center');
text(t_plot(1)+2.5, y_plot_cdot(2)-0.10, 'MHIH','FontName','AvenirBold','FontSize',fontsize,'Color',[0.9290    0.6940    0.1250],'HorizontalAlignment','center');
...
legend(['QIET' char(8211) 'SQ21'],['QIET' char(8211) 'SQ25'],['MLOW' char(8211) 'SQ21'],['MLOW' char(8211) 'SQ22'],['MLOW' char(8211) 'SQ25'],...
    'NumColumns',3,    'Location','West','EdgeColor','none');    % 'Position',[0.345 0.545 0.01 0.01],'EdgeColor','none')
set(gca,'FontName','Avenir','tickdir','in','LineWidth',0.6,'FontSize',fontsize); 
set(gca,'ytick',y_plot_strain(1)+y_plot_strain_tick:y_plot_strain_tick:y_plot_strain(2))
...
ylabel('Runoff [cm w.e.] \hspace{6mm} $\dot{c}$  [ m d$^{-1}$ ] \hspace{0mm}','Interpreter','latex','FontSize',fontsize)
set(gca,'ytick',y_plot_cdot(1)+y_plot_cdot_tick:y_plot_cdot_tick:y_plot_cdot(2),'YTickLabel',run_c_dot_label);
text(t_plot(2)-0.15,y_plot_cdot(2)-0.75,'within-basin 20s','FontName','AvenirBold','FontSize',fontsize+1,'FontAngle','italic','HorizontalAlignment','right')
text(t_plot(1)-0.80, y_plot_cdot(2),'d','FontName','Helvetica','FontSize',fontsize+2);
text(t_plot(1)+0.5, y_plot_cdot(2)-0.10, 'SQ21','FontName','AvenirBold','FontSize',fontsize,'Color',[0    0.4470    0.7410],'HorizontalAlignment','center');
text(t_plot(1)+1.5, y_plot_cdot(2)-0.10, 'SQ22','FontName','AvenirBold','FontSize',fontsize,'Color',[0.8500    0.3250    0.0980],'HorizontalAlignment','center');
text(t_plot(1)+2.5, y_plot_cdot(2)-0.10, 'SQ23','FontName','AvenirBold','FontSize',fontsize,'Color',[0.9290    0.6940    0.1250],'HorizontalAlignment','center');
text(t_plot(1)+3.5, y_plot_cdot(2)-0.10, 'SQ24','FontName','AvenirBold','FontSize',fontsize,'Color',[0.4940    0.1840    0.5560],'HorizontalAlignment','center');
text(t_plot(1)+4.5, y_plot_cdot(2)-0.10, 'SQ25','FontName','AvenirBold','FontSize',fontsize,'Color',[0.4660    0.6740    0.1880],'HorizontalAlignment','center');
text(t_plot(1)+5.5, y_plot_cdot(2)-0.10, 'SQ26','FontName','AvenirBold','FontSize',fontsize,'Color',[0.3010    0.7450    0.9330],'HorizontalAlignment','center');
text(t_plot(1)+6.5, y_plot_cdot(2)-0.10, 'SQ27','FontName','AvenirBold','FontSize',fontsize,'Color',[0.6350    0.0780    0.1840],'HorizontalAlignment','center');
...
for i=3 % lakes filling and draining
    ...
    rectangle('Position',[lake_dates(i) y_plot_strain(1) 1 y_plot_strain(2)-y_plot_strain(1)],...
     ...
     text(188+0.25,-0.035,'L2A, L2B filling...',...
         'FontName','AvenirBold','FontSize',fontsize+1,'FontAngle','italic','HorizontalAlignment','left')
end
...
'Location','West','EdgeColor','none');     % 'Position',[0.2525 0.445 0.01 0.01],'EdgeColor','none') 
set(gca,'FontName','Avenir','tickdir','in','LineWidth',0.6,'FontSize',fontsize); 
set(gca,'ytick',y_plot_strain(1)+y_plot_strain_tick:y_plot_strain_tick:y_plot_strain(2))
...
ylabel('Runoff [cm w.e.] \hspace{6mm} $\dot{c}$  [ m d$^{-1}$ ] \hspace{0mm}','Interpreter','latex','FontSize',fontsize)
set(gca,'ytick',y_plot_cdot(1)+y_plot_cdot_tick:y_plot_cdot_tick:y_plot_cdot(2),'YTickLabel',run_c_dot_label);
text(t_plot(2)-0.15,y_plot_cdot(2)-0.75,'within-basin 30s','FontName','AvenirBold','FontSize',fontsize+1,'FontAngle','italic','HorizontalAlignment','right')
text(t_plot(1)-0.80, y_plot_cdot(2),'e','FontName','Helvetica','FontSize',fontsize+2);
text(t_plot(1)+0.5, y_plot_cdot(2)-0.10, 'SQ31','FontName','AvenirBold','FontSize',fontsize,'Color',[0    0.4470    0.7410],'HorizontalAlignment','center');
text(t_plot(1)+1.5, y_plot_cdot(2)-0.10, 'SQ34','FontName','AvenirBold','FontSize',fontsize,'Color',[0.8500    0.3250    0.0980],'HorizontalAlignment','center');
text(t_plot(1)+2.5, y_plot_cdot(2)-0.10, 'SQ35','FontName','AvenirBold','FontSize',fontsize,'Color',[0.9290    0.6940    0.1250],'HorizontalAlignment','center');
text(t_plot(1)+3.5, y_plot_cdot(2)-0.10, 'SQ36','FontName','AvenirBold','FontSize',fontsize,'Color',[0.4940    0.1840    0.5560],'HorizontalAlignment','center');
text(t_plot(1)+4.5, y_plot_cdot(2)-0.10, 'SQ37','FontName','AvenirBold','FontSize',fontsize,'Color',[0.4660    0.6740    0.1880],'HorizontalAlignment','center');
...
text(lake_fill_dates(4)+0.25,-0.035,'L3A, L3B filling...',...
         'FontName','AvenirBold','FontSize',fontsize+1,'FontAngle','italic','HorizontalAlignment','left')
...
%% print figure
print(gcf,'-dpng','-r300',sprintf('../../paperfigs/suppfig1.2_C1_cdot_distillations_260119.png')); 

%% 165-230 averages of c_dot_err (fot Table S11)
for i = 1:21; xxx(i,1) = nanmean(daily_epsilon_zz(i).c_dot_delta_t_combo_err); end

% check figure: do errors in c_dot vary across array? (answer: yes, slightly)
figure; clf; 
plot(1:1:21,xxx,'^-'); hold on
%lgd = legend('TRACK bias flag > 2','outlier (>3\sigma from running mean)','TRACK Up 1\sigma estimate > 0.0425 m','Location','East');
ylabel('$1\sigma$ errors on $\dot{c}$  [ m d$^{-1}$ ] \hspace{0mm}','Interpreter','latex'); 
xlabel('Station ID'); title('2022/165–230')
set(gca,'xticklabel',upper(station_names_short),'xtick',1:1:21); 
grid on; xlim([0 22])
% print figure
%print(gcf,'-dpng','-r300',sprintf('C1/sigma1_c_dot_2022_165_230_260121.png')); 
