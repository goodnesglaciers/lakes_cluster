...
[index_200] = find((strain_time>= 200),1);
...
% SQ15 not past 210 (fell over)
[index_230] = find((strain_time>= 211),1);
...
text(t_plot(2)-0.25,y_plot_cdot(2)-0.40,'within-basin 950s','FontName','AvenirBold','FontSize',fontsize+1,'FontAngle','italic','HorizontalAlignment','right')
text(t_plot(1)-0.75, y_plot_cdot(2),'a','FontName','Helvetica','FontSize',fontsize+2);

text(t_plot(1)+0.5, y_plot_cdot(2)-0.2, 'SQ11','FontName','AvenirBold','FontSize',fontsize,'Color',[0    0.4470    0.7410],'HorizontalAlignment','center');
text(t_plot(1)+1.5, y_plot_cdot(2)-0.2, 'SQ12','FontName','AvenirBold','FontSize',fontsize,'Color',[0.8500    0.3250    0.0980],'HorizontalAlignment','center');
text(t_plot(1)+2.5, y_plot_cdot(2)-0.2, 'SQ13','FontName','AvenirBold','FontSize',fontsize,'Color',[0.9290    0.6940    0.1250],'HorizontalAlignment','center');
text(t_plot(1)+3.5, y_plot_cdot(2)-0.2, 'SQ14','FontName','AvenirBold','FontSize',fontsize,'Color',[0.4940    0.1840    0.5560],'HorizontalAlignment','center');
text(t_plot(1)+4.5, y_plot_cdot(2)-0.2, 'SQ15','FontName','AvenirBold','FontSize',fontsize,'Color',[0.4660    0.6740    0.1880],'HorizontalAlignment','center');
text(t_plot(1)+5.5, y_plot_cdot(2)-0.2, 'SQ16','FontName','AvenirBold','FontSize',fontsize,'Color',[0.3010    0.7450    0.9330],'HorizontalAlignment','center');
...
ylabel('Runoff [cm w.e.] \hspace{6mm} $\dot{c}$  [ m d$^{-1}$ ] \hspace{0mm}','Interpreter','latex','FontSize',fontsize)
set(gca,'ytick',y_plot_cdot(1)+y_plot_cdot_tick:y_plot_cdot_tick:y_plot_cdot(2),'YTickLabel',run_c_dot_label);
text(t_plot(2)-0.25,y_plot_cdot(2)-0.40,'950s-to-tiepoints','FontName','AvenirBold','FontSize',fontsize+1,'FontAngle','italic','HorizontalAlignment','right')
...
set(gca,'ytick',y_plot_cdot(1)+y_plot_cdot_tick:y_plot_cdot_tick:y_plot_cdot(2),'YTickLabel',run_c_dot_label);
text(t_plot(2)-0.25,y_plot_cdot(2)-0.40,'tiepoints-to-1150s','FontName','AvenirBold','FontSize',fontsize+1,'FontAngle','italic','HorizontalAlignment','right')
...
ylabel('Runoff [cm w.e.] \hspace{6mm} $\dot{c}$  [ m d$^{-1}$ ] \hspace{0mm}','Interpreter','latex','FontSize',fontsize)
set(gca,'ytick',y_plot_cdot(1)+y_plot_cdot_tick:y_plot_cdot_tick:y_plot_cdot(2),'YTickLabel',run_c_dot_label);
text(t_plot(2)-0.25,y_plot_cdot(2)-0.40,'within-basin 1150s','FontName','AvenirBold','FontSize',fontsize+1,'FontAngle','italic','HorizontalAlignment','right')
text(t_plot(1)-0.75, y_plot_cdot(2),'d','FontName','Helvetica','FontSize',fontsize+2);

% text(lake_dates(2)+0.5, y_plot_cdot(2)+0.05, 'MHIH, L3B','FontName','AvenirBold','FontSize',fontsize+1,...
%     'FontAngle','italic','HorizontalAlignment','left','Rotation',75); 
text(lake_dates(3)+0.25, y_plot_cdot(1)+0.45, {'L2A';'L2B'},'FontName','AvenirBold','FontSize',fontsize+1,...
...
text(t_plot(1)+0.5, y_plot_cdot(2)-0.50, 'SQ26','FontName','AvenirBold','FontSize',fontsize,'Color',[0.3010    0.7450    0.9330],'HorizontalAlignment','center');
text(t_plot(1)+1.5, y_plot_cdot(2)-0.50, 'SQ27','FontName','AvenirBold','FontSize',fontsize,'Color',[0.6350    0.0780    0.1840],'HorizontalAlignment','center');
...
ylabel('Runoff [cm w.e.] \hspace{6mm} $\dot{c}$  [ m d$^{-1}$ ] \hspace{0mm}','Interpreter','latex','FontSize',fontsize)
set(gca,'ytick',y_plot_cdot(1)+y_plot_cdot_tick:y_plot_cdot_tick:y_plot_cdot(2),'YTickLabel',run_c_dot_label);
text(t_plot(2)-0.25,y_plot_cdot(2)-0.40,'within-basin 1350s','FontName','AvenirBold','FontSize',fontsize+1,'FontAngle','italic','HorizontalAlignment','right')
...
text(lake_fill_dates(4)+0.25,0.125,'L3A, L3B filling...',...
         'FontName','AvenirBold','FontSize',fontsize+1,'FontAngle','italic','HorizontalAlignment','left')
text(210+0.15,-0.040,'L3A',...
         'FontName','AvenirBold','FontSize',fontsize+1,'FontAngle','italic','HorizontalAlignment','left')
...
%% print figure
print(gcf,'-dpng','-r300',sprintf('../../paperfigs/suppfig3.2_C3_cdot_distillations_260119.png')); 
